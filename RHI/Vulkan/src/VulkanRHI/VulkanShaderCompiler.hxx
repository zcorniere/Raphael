...
public:
    ...
    VulkanShader* Get(std::filesystem::path Path, bool bForceCompile = false);

private:
    VulkanShader* CheckCache(ShaderCompileResult& Result);
...
private:
    ...
    std::unordered_map<std::string, VulkanShader*> m_ShaderCache;
};
